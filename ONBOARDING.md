...
The following resources can be useful for learning what you'll need to know about git and GitHub:
  ...
  - Resources:
    ...
    - [Git Immersion](https://gitimmersion.com/): A tutorial that walks through a series of short hands-on exercises that provide 
practice with the key features of git.
